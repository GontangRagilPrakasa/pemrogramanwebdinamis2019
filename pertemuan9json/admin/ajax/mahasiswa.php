...
sleep(1);
 ...
 $query = mysqli_query($konek,"SELECT * FROM pwd2 WHERE nim LIKE '%$keyword%' OR username LIKE '%$keyword%' OR jenis_kelamin LIKE '%$keyword%' OR alamat LIKE '%$keyword%' OR asal LIKE '%$keyword%' OR ttl LIKE '%$keyword%' OR email LIKE '%$keyword%'") or die (mysqli_error($konek));
 // var_dump($mahasiswa);
?>
