...
https://masrud.com/post/membuat-dan-memanipulasi-json-dengan-php -->
<!DOCTYPE>
<html>
<head>
...
<body>
	...
	<div class="container">
		...
		<a href="mahasiswa.json" class="btn btn-primary btn-lg">
     	 <span class="glyphicon glyphicon-print"></span> JSON  
    	</a>
		  ...
		  <?php 
		  	//ambil data json dari createjson
         	$file = "mahasiswa.json";
         	//ambil seluruh data json
			$mahasiswa = file_get_contents($file);
			//generete dari json dari data
			$datajson = json_decode($mahasiswa, true);
		    $no=1;
